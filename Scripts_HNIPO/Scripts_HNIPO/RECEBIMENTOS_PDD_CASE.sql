...
SELECT 
    ...
    NF,
    VCTO,
    CASE WHEN ANOVCTO IN ('2012','2013','2014','2015') THEN '0' ELSE TO_CHAR(JANEIRO)  END JANEIRO,
    CASE WHEN ANOVCTO IN ('2012','2013','2014','2015') THEN '0' ELSE TO_CHAR(FEVEREIRO)  END FEVEREIRO,
    CASE WHEN ANOVCTO IN ('2012','2013','2014','2015') THEN '0' ELSE TO_CHAR(MARCO)  END MARCO,
    CASE WHEN ANOVCTO IN ('2012','2013','2014','2015') THEN '0' ELSE TO_CHAR(ABRIL)  END ABRIL,
    CASE WHEN ANOVCTO IN ('2012','2013','2014','2015') THEN '0' ELSE TO_CHAR(MAIO)  END MAIO, 
    CASE WHEN ANOVCTO IN ('2012','2013','2014','2015') THEN '0' ELSE TO_CHAR(JUNHO)  END JUNHO,
    CASE WHEN ANOVCTO IN ('2012','2013','2014','2015') THEN '0' ELSE TO_CHAR(JULHO)  END JULHO,
    CASE WHEN ANOVCTO IN ('2012','2013','2014','2015') THEN '0' ELSE TO_CHAR(AGOSTO)  END AGOSTO, 
    CASE WHEN ANOVCTO IN ('2012','2013','2014','2015') THEN '0' ELSE TO_CHAR(SETEMBRO)  END SETEMBRO, 
    CASE WHEN ANOVCTO IN ('2012','2013','2014','2015') THEN '0' ELSE TO_CHAR(OUTUBRO)  END OUTUBRO, 
    CASE WHEN ANOVCTO IN ('2012','2013','2014','2015') THEN '0' ELSE TO_CHAR(NOVEMBRO)  END NOVEMBRO,   
    CASE WHEN ANOVCTO IN ('2012','2013','2014','2015') THEN '0' ELSE TO_CHAR(DEZEMBRO)  END DEZEMBRO,
    CASE WHEN ANOVCTO IN ('2012','2013','2014','2015') THEN '0' ELSE TO_CHAR(TOTAL) END TOTAL
   -- TOTAL          
...
where x2.nr_id_nota_fiscal = 262581


select * from mov_glosas x where x.cd_remessa = 33849 ---for update;
select * from itcon_Rec where cd_con_rec = 93283-- for update-- cd_itcon_Rec = 139063 for update
select * from reccon_rec where cd_itcon_rec = 93862 --for update 
