...
From Dbamv.Reg_Fat Where Cd_Remessa In (101126)-- and cd_conta_pai in (979698)--for update;

select g.nr_guia,g.nr_guia_operadora,g.nm_paciente ,g.nm_prestador_exe, g.cd_reg_fat,g.cd_reg_amb ,g.vl_tot_geral , g.vl_total_geral_hono 
from dbamv.tiss_guia g where g.cd_remessa in (489420) order by 1 --for update ---ORDER BY --  and g.nm_xml in ('guiaHonorarioIndividual','guiaSP_SADT') order by 1--and g.cd_remessa = 65212 o
--cd_atendimento = 1086589 and cd_reg_fat = 1017993 --24248,04
...
select * from tiss_guia xx where xx.cd_reg_fat = 249666
