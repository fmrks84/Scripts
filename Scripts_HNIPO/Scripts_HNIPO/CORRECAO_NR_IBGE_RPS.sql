...
SELECT x.cd_cidade FROM NOTA_FISCAL X WHERE X.Nr_Id_Nota_Fiscal IN (9394) -- 1º

select y.nm_cidade,y.cd_ibge, y.nr_digito_ibge from cidade y where y.cd_cidade in (9072)--,13185)  -- 2°

-- consultar o numero do ibge na internet site  : https://cidades.ibge.gov.br/brasil/sp/sao-paulo/panorama

update cidade set cidade.nr_digito_ibge = 4 /*cd_ibge = '311060'*/ where cd_cidade = '9072'; -- 3° 
commit -- 3º 
