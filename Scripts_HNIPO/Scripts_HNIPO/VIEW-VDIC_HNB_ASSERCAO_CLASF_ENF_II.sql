...
-- 06/08/2019  -  PREPARADO PARA CONSIDERAR DOCUMENTOS DO PEP II DO P.A. ( NO AGUARDO DA CRIAÇÃO DOS MESMOS )
...
--------------------------------------------------------------------
--- ESTE CAMPO É O TEXTO DA RESPOSTA DA PERGUNTA "CONCORDA COM A CLASSIFICÇAO INICIAL'
--  DOS NOVOS DOCUMENTOS DE ANAMNESES PEP II QUE IRA PARA A COLUNA DO RELATÓRIO "PERGUNTA RESPONDIDA"
--  É PRECISO REVER PORQUE HOJE (06/08/2019 ) AINDA NÃO EXISTE OS NOVOS DOUMENTOS DE ANAMNESES
...
-------------------------------------------------------------------------------
--- ESTE BLOCO É PARA OBTER O TEXTO DA RESPOSTA DA PERGUNTA "CONCORDA COM A CLASSIFICÇAO INICIAL'
--  DOS NOVOS DOCUMENTOS DE ANAMNESES PEP II QUE IRA PARA A COLUNA DO RELATÓRIO "PERGUNTA RESPONDIDA"
--  É PRECISO REVER ESSA LÓGICA PORQUE HOJE (06/08/2019 ) AINDA NÃO EXISTE OS NOVOS DOUMENTOS DE ANAMNESES
...
-----                                                  QUANDO ENTRAR O PEP II
 ...
 -- AND     ERC.CD_CAMPO IN (28211)        -- PERGUNTA 'não concorda com a classificalcao inicial"    ----  excluida resposta 28082 = "sim"
...
AND J.DS_IDENTIFICADOR IN ('CK_N_CONCORD_CLASS_INI_1', 
                            ...
                            'CK_N_CONCORD_CLASS_INI_1')
AND E.DH_CRIACAO > =  to_date('01/02/2020','DD/MM/RRRR')
