select 'Interno',
 ...
 where v.cd_motivo_auditoria = m.cd_motivo_auditoria
  ...
  ---and v.cd_reg_fat is not null
   --and r.cd_remessa = 479670
   --and f.dt_competencia = '01/09/2022'
  --and to_char(f.dt_competencia,'mm/yyyy') = '10/2022'  --12/2020
 --- and v.cd_atendimento = 4198862
  and r.cd_reg_fat in (479670,479796)
 -- and r.cd_multi_empresa in (3,4,7,10,11,25)
...
select 'Ambulatorio',
 ...
 --  and to_char(f.dt_competencia,'mm/yyyy') = '10/2022'
  -- and f.dt_competencia = '01/09/2022'
-- and r.cd_multi_empresa in (3,4,7,10,11,25)


select * from 
select * from reg_fat where cd_reg_Fat in (479670,479796)
