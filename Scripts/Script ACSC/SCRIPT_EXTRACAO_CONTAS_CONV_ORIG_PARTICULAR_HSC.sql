/*precisamos elaborar um estudo solicitado pela diretoria executiva, para isso precisamos extrair uma base consolidada com informações de faturamento e contas a receber.

Critérios a serem considerados:

Para lista de atendimentos em anexo, precisamos incluir as colunas:
1 - soma do valor faturado convênio particular (40)
2 - soma do valor faturado convênios (diferente de particular).
...
case when irc.tp_quitacao = 'C' then 'Comprometido' 
     ...
     else 'Em remessa na operadora'||' - '||rf.cd_remessa
     end status_receb
from 
dbamv.atendime atd 
