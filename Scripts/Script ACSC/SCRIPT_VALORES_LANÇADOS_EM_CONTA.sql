...
and   r.cd_convenio = &cd_convenio
and   it.cd_tab_fat = &cd_tab_fat
and   i.cd_pro_Fat = &cd_pro_fat
and   i.hr_lancamento between To_Date ('01/05/2022','dd/mm/yyyy') AND To_Date ('31/07/2022','dd/mm/yyyy')
and   i.vl_unitario = '38.16'
