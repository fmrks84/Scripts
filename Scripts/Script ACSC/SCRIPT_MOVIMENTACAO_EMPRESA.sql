...
(6000659)--(4905377,4905636,4906190,4914786,4914193,4910159,4911160)--Empresa 4
order by 2
...
where it.cd_atendimento in (6000659)--(4905377,4905636,4906190,4914786,4914193,4910159)
