...
ELSE P.NM_PACIENTE END NM_PACIENTE,
 ...
 WHERE A.CD_ATENDIMENTO = R.CD_ATENDIMENTO
   AND R.CD_MULTI_EMPRESA = 3---'{cdMultiEmpresa}'
   ...
   AND AC.SN_PERTENCE_PACOTE = 'N'--ADICIONADO PARA CHAMAR A COUNA SN_PERTENCE_PACOTE
...
ELSE P.NM_PACIENTE END NM_PACIENTE,
 ...
 WHERE EMPRESA_CONVENIO.CD_CONVENIO = C.CD_CONVENIO
   AND EMPRESA_CONVENIO.CD_MULTI_EMPRESA = 3--'{cdMultiEmpresa}'
...
--Q
WHERE Q.DT_AUDITORIA > = '01/05/2021'--Q.CONTA = {V_CD_REG}
