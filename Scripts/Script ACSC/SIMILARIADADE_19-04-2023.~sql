...
where to_char(atd.dt_atendimento,'dd/mm/rrrr') between '01/01/2022' and '18/04/2023'
...
;
select * from imp_simpro xp where xp.cd_pro_fat = 70252980;
select * from tuss ts where ts.cd_tuss = '70252980'
