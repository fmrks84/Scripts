...
--4)  Relação de atendimentos e contas que tiveram passagem nos Centros Cirúrgicos no período e que realizaram procedimento cirúrgico da especialidade Ortopedia e Traumatologia
...
select cd_aviso_cirurgia from cirurgia_Aviso where cd_especialid in (44)))
