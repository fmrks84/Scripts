...
--1)  Relação de atendimentos e contas que tiveram passagem nos Centros Cirúrgicos e UTI (deverá conter também as colunas (CD_PRO_FAT/ DS_PRO_FAT) e as demais informações que constam em relatórios que você já nos enviou. Ex.: Faturamento
