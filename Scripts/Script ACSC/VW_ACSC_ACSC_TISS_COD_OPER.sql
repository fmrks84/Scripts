CREATE OR REPLACE VIEW VW_ACSC_TISS_COD_OPER AS (
...
GRANT SELECT ON VW_ACSC_TISS_COD_OPER TO dbaMV
;    

SELECT X.COD_OPERADORA FROM VW_ACSC_TISS_COD_OPER X WHERE X.CD_ATENDIMENTO = :PAR3
