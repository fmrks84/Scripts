...
--and trunc(b.dt_realizacao) between '01/01/2021' and sysdate  -- definir a data dos lançamentos 
--and c.cd_cirurgia = 1858  -- definir se deverá somente realizar o inicio dos teste em um codigo de cirurgia
...
---- tabela para lançamentos em conta 
--- OBS: LANÇAMENTO DEVE SER NA CONTA QUE CORRESPONDE A DATA QUE FOI INSERIDO O INICIO E FIM DA ANESTESIA
...
itreg_fat.cd_pro_fat, --(60011335,600004894,60028572) --AO SER FINALIZADO A CONFIRMAÇÃO DA CIRUGIA LANÇAR 1 ITEM DE CADA NA CONTA 
to_Date(itreg_fat.dt_lancamento,'DD/MM/YYYY')dt_lancamento, -- deverá ser igual dt_fim_anestesia
itreg_fat.hr_lancamento, -- deverá ser igual dt_fim_anestesia
itreg_Fat.Qt_Lancamento, -- quando HORA_MINUTOS > 1H:30MIN LANÇAR +1 PRO_FAT DE CADA 
