...
SELECT distinct V.*, ATENDIME.TP_ATENDIMENTO
...
And Empresa_Convenio.Cd_Multi_Empresa = 7 --{cdMultiEmpresa}
...
AND   REG_FAT.CD_MULTI_EMPRESA = 7 --{cdMultiEmpresa}
AND   CONVENIO.TP_CONVENIO NOT IN ('H', 'A')
AND   ITREG_FAT.CD_SETOR  = 39

AND ITREG_FAT.DT_LANCAMENTO >= TO_DATE('26/07/2021 00:00:00','DD/MM/RRRR HH24:MI:SS') --@DT_INI,'DD/MM/RRRR HH24:MI:SS')
AND ITREG_FAT.DT_LANCAMENTO <  TO_DATE('26/07/2021 00:00:00','DD/MM/RRRR HH24:MI:SS')+1 --@DT_FIM,'DD/MM/RRRR HH24:MI:SS') + 1
...
AND   REG_AMB.CD_MULTI_EMPRESA = 7 --{cdMultiEmpresa}
AND   CONVENIO.TP_CONVENIO NOT IN ('H', 'A')
AND   ITREG_AMB.CD_SETOR = 39

AND ATENDIME.DT_ATENDIMENTO >= TO_DATE('26/07/2021 00:00:00','DD/MM/RRRR HH24:MI:SS') --@DT_INI,'DD/MM/RRRR HH24:MI:SS')
AND ATENDIME.DT_ATENDIMENTO <  TO_DATE('26/07/2021 00:00:00','DD/MM/RRRR HH24:MI:SS')+1 --@DT_FIM,'DD/MM/RRRR HH24:MI:SS') + 1
--AND ATENDIME.CD_CONVENIO IN ({CD_CONVENIO_AUX})
AND ITREG_AMB.CD_PRESTADOR = 3767 --NVL(ITREG_AMB.CD_PRESTADOR,0) = NVL('{NM_PRESTADOR}',NVL(ITREG_AMB.CD_PRESTADOR,0)) --C2106/7087
--AND ATENDIME.TP_ATENDIMENTO IN ({V_TP_ATEND_AUX})  --C2106/12553
...
AND Trunc(ATENDIME.DT_ATENDIMENTO) >= TO_DATE('26/07/2021') --@DT_INI,'DD/MM/RRRR HH24:MI:SS')
AND Trunc(ATENDIME.DT_ATENDIMENTO) <= TO_DATE('26/07/2021') --@DT_FIM,'DD/MM/RRRR HH24:MI:SS') + 1
--AND ATENDIME.CD_CONVENIO IN ({CD_CONVENIO_AUX})
AND ITREG_AMB.CD_PRESTADOR = 3767 --NVL(ITREG_AMB.CD_PRESTADOR,0) = NVL('{NM_PRESTADOR}',NVL(ITREG_AMB.CD_PRESTADOR,0)) --C2106/7087
--AND ATENDIME.TP_ATENDIMENTO IN ({V_TP_ATEND_AUX}) --C2106/12553
...
AND V.DT_LANCAMENTO >= TO_DATE('26/07/2021 00:00:00','DD/MM/RRRR HH24:MI:SS') --@DT_INI,'DD/MM/RRRR HH24:MI:SS')
AND V.DT_LANCAMENTO <  TO_DATE('26/07/2021 00:00:00','DD/MM/RRRR HH24:MI:SS')+1 --@DT_FIM,'DD/MM/RRRR HH24:MI:SS') + 1
