...
inner join val_pro vp on vp.cd_pro_fat = pf.cd_pro_fat --and vp.cd_tab_fat in (941,824)
...
and ts.cd_tip_tuss in (19,00)
--and pd.cd_produto = 355
...
select * from tip_presc p where p.cd_pro_fat in ('20103310','20203012');
select * from mov_int where cd_atendimento = 5460162 
select * from exa_rx rx where rx.exa_rx_cd_pro_fat = '20103310'
