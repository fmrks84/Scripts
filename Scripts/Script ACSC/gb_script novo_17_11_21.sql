--- Premissas 
-- valor procedimento , tabela faturamento , pro_Fat , dt_inicio e fim 
-- conveter em excel "Copy all to excel"
...
i.dt_Lancamento,
'&valor'vl_simpro_vl_brasindice  -- colocar o valor brasindice ou simpro 
...
and   it.cd_tab_fat = t.cd_tab_fat
and   i.sn_pertence_pacote = 'N'
and   it.cd_tab_fat in ('&cd_tab_Fat') 
--AND   it.cd_regra in (24,25,236)
and c.tp_convenio = 'C'
and   i.sn_pertence_pacote = 'N'
and   i.cd_pro_Fat in ('&cd_pro_fat')-- 40304809
and   i.hr_lancamento between   '&dt_lancamento' and '&dt_lancamento_fim'
)--- 10,66
...
and c.tp_convenio = 'C'
and   i.sn_pertence_pacote = 'N'
and   i.cd_pro_Fat  in ('&cd_pro_fat') -- 10009998,10009997
and   i.dt_lancamento  between  '&dt_lancamento' and '&dt_lancamento_fim'
