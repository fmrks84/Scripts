...
select * from ensemble.vw_atendimento_faturamento where cd_Atendimento in (3310387, 3310818, 3309522, 3309714, 3311098,3310566);
select * from ensemble.vw_autorizacao_faturamento where cd_atendimento in (3310723);
