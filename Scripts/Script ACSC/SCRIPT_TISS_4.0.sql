...
-- chave tiss 4.0 TELA NOVA APURAÇÃO DE IMPORTAÇÃO DE PAGAMENTOS
 --FFCV  M_CONVENIO_CONF_TISS  VALOR = S  DESC = TELA NOVA APURAÇÃO DE IMPORTAÇÃO DE PAGAMENTOS  
--select * from configuracao b where b.chave = 'SN_NOVA_APURACAO_TISS' AND b.cd_multi_empresa = 3
update dbamv.configuracao set valor = 'S' where chave = 'SN_NOVA_APURACAO_TISS' ;
commit;
...
--- inserir acesso a tela m_baixa_lote para os usuários
...
--select * from dbasgu.usuarios x where x.cd_usuario = 'DBAMV' 
