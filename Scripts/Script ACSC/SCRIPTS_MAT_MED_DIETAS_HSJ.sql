...
inner join gru_pro gp on gp.cd_gru_pro =  pf.cd_gru_pro --and gp.cd_gru_pro  in (8,9,89,95,96)-- MAT(8,91,89,95,96)--(7,8,12,15,43,44,71,89,91,92,94,95,96)
inner join tuss ts on ts.cd_pro_fat = pf.cd_pro_fat and ts.cd_tip_tuss in (00,19,20/*,20,22*/)
...
where emp.cd_multi_empresa in (10)
