...
select * from sys.reg_fat_audit where /*o_cd_atendimento = 4688994 and*/ cd_reg_Fat = 683296   order by dt_aud desc 
...
select * from audit_dbamv.reg_fat itr where itr.cd_reg_fat = 68329  and itr.cd_pro_fat = 78363403
...
select * from audit_dbamv.reg_fat where cd_reg_Fat = 
