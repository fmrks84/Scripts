...
SELECT atendime.cd_atendimento,
        ...
        ori_ate.cd_ori_ate||' - '||ori_ate.ds_ori_ate OrigemAtendimento --- incluido 15/06/2021
   ...
   FROM dbamv.atendime,
        ...
        dbamv.ori_ate -- incluido 15/06/2021
WHERE convenio.tp_convenio = 'C'
  ...
  and ori_ate.cd_ori_ate = atendime.cd_ori_ate; --incluido 15/06/2021
