create or replace view ensemble.vw_ovmd_guia_interna_urgencia as
select r.cd_multi_empresa,
             ...
             decode(t.cd_carater_solicitacao,'E','Eletiva','U','Urg¿ncia') ds_carater,
             decode(t.cd_tipo_internacao,'1','Clinica','2','Cir¿rgica','3','Obstetrica',t.cd_tipo_internacao) cd_tipo_internacao,
             t.cd_cid,
             it.cd_procedimento,
             it.ds_procedimento,
             it.qt_solicitada,
...
select r.cd_multi_empresa,
       ...
       t.cd_cbos,
       t.ds_hda ds_indicacao,
       decode(t.cd_carater_solicitacao,'E','Eletiva','U','Urgencia') ds_carater,
       decode(t.cd_tipo_internacao,'1','Clinica','2','Cirurgica','3','Obstetrica',t.cd_tipo_internacao) cd_tipo_internacao,
       t.cd_cid,
