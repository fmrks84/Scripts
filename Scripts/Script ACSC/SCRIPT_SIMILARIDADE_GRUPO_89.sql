...
---   AND  P.CD_CLASSE IN (3,1)
 --  AND P.CD_SUB_CLA IN (2,5,7,8,9,10,12,14,17)
   and pf.cd_gru_pro in (8, 9,57, 66, 89, 91, 95, 96)
   and m.sn_movimentacao = 'S'
  -- and pf.cd_pro_fat in ('70705275','70705259')                   
   AND  empresa_produto.cd_multi_empresa IN (7)-- --{cdMultiEmpresa}
...
left join tuss ts on ts.cd_pro_fat = opme.cd_pro_Fat and ts.cd_multi_empresa = opme.cd_multi_empresa
and ts.cd_convenio is null
where to_char(atd.dt_atendimento,'dd/mm/rrrr') between '01/09/2022' and '01/09/2023'
--and irf.cd_pro_fat = '70252980'
...
--SELECT * FROM especie where cd_especie in (19,20)
