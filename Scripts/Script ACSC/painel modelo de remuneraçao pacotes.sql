...
where  tff.cd_convenio  = 5 
and tff.cd_agrupamento in (4,5,8)
and tff.cd_ori_ate in (9,10,26,27,101) 
...
and dt_competencia>= to_date ('01/01/2018','dd/mm/rrrr')
and cd_convenio  = 5 
and tff.cd_ori_ate not in (9,10,26,27,101)
and tff.cd_multi_empresa = 7 
