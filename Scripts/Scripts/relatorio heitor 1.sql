...
and a.dt_atendimento BETWEEN  To_Date ('01/01/2018','dd/mm/yyyy') AND To_Date ('28/05/2021','dd/mm/yyyy')
and a.cd_multi_empresa = 3
and r.cd_convenio in (66,102,261)
...
where c.dt_atendimento BETWEEN  To_Date ('01/01/2018','dd/mm/yyyy') AND To_Date ('28/05/2021','dd/mm/yyyy')
and c.cd_multi_empresa = 3
and a.cd_convenio in (66,102,261) 
